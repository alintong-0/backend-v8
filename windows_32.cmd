...
set searchString2="https://chromium.googlesource.com/v8/v8"
set replaceString2="https://github.com/alintong-0/v8"
...
powershell -Command "(Get-Content %inputFile2%) -replace '%searchString%', '%replaceString%' | Set-Content %inputFile2%"
